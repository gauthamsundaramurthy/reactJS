...
class Inshorts extends React.Component {
   ...
   render() {
	...
	<div className="container">
			<div className="sub_container">
				...
				<div className="article_msg"> 
					...
					<p className="article_msg_main"> MS Dhoni signalled to take a DRS review even before the umpire could completely raise his finger to declare Jasprit Bumrah out in the first ODI against Sri Lanka. Dhoni took the call from the non-striker's end after the Sri Lankan team appealed for LBW. The review found that the ball had pitched outside off-stump, resulting in the decision's reversal.</p>
			...
			<div className="sub_container first">
	...
	<div id="footer">
		...
		<a href={facebook} target="_blank"> <img className="footer_social_logo" src={facebook_img} alt="facebook_img"/> </a>

		<a href={twitter} target="_blank"> <img className="footer_social_logo" src={twitter_img} alt="twitter_img"/></a>

		<a href={linkedIn} target="_blank"><img className="footer_social_logo" src={linkedIn_img} alt="linkedin_img"/> </a>
